# -*- coding: utf-8 -*-
"""
Created on Mon Aug  1 21:36:01 2016
...
max_steering_angle = math.pi / 4.0 # You do not need to use this value, but keep in mind the limitations of a real car.
...
class robot:
    ...
    def __init__(self, length = 20.0):
        ...
        self.orientation = random.random() * 2.0 * math.pi # initial orientation
    ...
    def measurement_prob(self, measurements):
        ...
        for i in range(len(measurements)):
            ...
            error_bearing = (error_bearing + math.pi) % (2.0 * math.pi) - math.pi # truncate
    ...
    def move(self, motion,tolerance=0.001): # Do not change the name of this function
        ...
        turn=math.tan(steering2)*distance2/res.length
        ...
        if abs(turn)<tolerance:
            ...
            res.orientation=(self.orientation+turn)%(2*math.pi)
    ...
    def sense(self,add_noise=1): #do not change the name of this function
        ...
        for i in range(len(landmarks)):
            ...
            bearing=math.atan2(landmarks[i][0]-self.y,landmarks[i][1]-self.x)-self.orientation
...
def get_position(p):
    ...
    for i in range(len(p)):
        ...
        # the 0=2pi problem
        orientation += (((p[i].orientation - p[0].orientation + math.pi) % (2.0 * math.pi)) 
                        + p[0].orientation - math.pi)
...
##
#motions = [[2. * math.pi / 10, 20.] for row in range(8)]
