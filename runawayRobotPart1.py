# -*- coding: utf-8 -*-
"""
Created on Sun Oct 30 21:43:44 2016
...
def estimate_next_pos(measurement, xi, yi,OTHER = None):
    ...
    if OTHER == None:
        ...
        heading = math.atan2(p2_dy,p2_dx) + turn_angle
        est_x = measurement[0] + distance * math.cos(heading)
        est_y = measurement[1] + distance * math.sin(heading)
...
def demo_grading(estimate_next_pos_fcn, target_bot, OTHER = None):
    ...
    while not localized and ctr <= 10: 
        ...
        position_guess, OTHER = estimate_next_pos_fcn(measurement,target_bot.x,target_bot.y, OTHER)
...
#measurements=test_target.sense()
#estimate_next_pos(measurements,test_target.x,test_target.y)
