# -*- coding: utf-8 -*-
"""
Created on Wed Sep 21 22:34:20 2016
...
class robot:
    ...
    def move(self, steering, distance, 
             tolerance = 0.001, max_steering_angle = math.pi / 4.0):
...
def run(param1,param2,param3):
    ...
    myrobot.set_steering_drift (10/180.0*math.pi)   
    N = 100
    #
    # Add Code Here
    integral_crosstrack_error=0.0
    crosstrack_error=myrobot.y
    for i in range(N):
        diff_crosstrack_error=myrobot.y-crosstrack_error
        crosstrack_error=myrobot.y
        integral_crosstrack_error+=crosstrack_error
        steer=-param1*crosstrack_error-param2*diff_crosstrack_error-param3*integral_crosstrack_error
